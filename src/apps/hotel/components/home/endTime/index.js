...
class CalendarTime extends React.Component {
    constructor(props) {
        super(props);
        let d =new Date()
        let nowDate = new Date(d.getFullYear(),d.getMonth(),d.getDate()+1);
    ...
    render() {
        ...
        hotelInfo.endTime = year + '-' + month + '-' + day
        hotelInfo.endDate = year + '-' + month + '-' + day + ' 00:00'
        hotelInfo.endHours = hours +':'+minutes
